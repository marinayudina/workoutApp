...
//  02
//
//  Created by Марина on 06.04.2023.
//
...
class TimerWorkoutViewController: UIViewController {
    ...
    private let shapeLayer = CAShapeLayer() //которая будет анимироваться
    ...
    private func addTaps() {
        ...
        timerLabel.isUserInteractionEnabled = true //обработать пользовательские нажатия
...
extension TimerWorkoutViewController {
    ...
    private func animationCircular() {
        ...
        let circularPath = UIBezierPath(arcCenter: center,//линия для анимации
                                        radius: 127,
        ...
        shapeLayer.strokeEnd = 1 //как бы длина окружности
        shapeLayer.lineCap = .round //закругленные углы
        ellipseImageView.layer.addSublayer(shapeLayer)
    }
    
    private func basicAnimation() {
        let basicAnimation = CABasicAnimation(keyPath: "strokeEnd")//от начала и до конца
